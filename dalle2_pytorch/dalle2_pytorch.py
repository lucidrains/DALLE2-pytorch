...
def get_upsample(upsample_type):
    if isinstance(upsample_type,int):
        upsample_type = UpsampleType(upsample_type)

    if upsample_type is None:
        upsample_type = UpsampleType.NearestUpsample

    if upsample_type == UpsampleType.NearestUpsample:
        return NearestUpsample
    elif upsample_type == UpsampleType.ConvTransposeUpsample:
        return ConvTransposeUpsample
    elif upsample_type == UpsampleType.UpsampleShuffle:
